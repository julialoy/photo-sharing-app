...
class Signin extends Component {
  ...
  handleSubmit(evt) {
    ...
    axios.post("http://www.hoard.pics/login",
        {
          user: {
            email: email,
            password: password
    ...
    return (
      <div id="loginBody" className="text-center">
        <form id="loginForm" className="form-signin" onSubmit={this.handleSubmit}>
          ...
          <button className="btn btn-lg btn-dark btn-block" type="submit" id="loginSubmit">
            Log in
          </button>
          <p>
            Have an invite code? <a href="/register-invite">Go here.</a>
          </p>
          <p>
